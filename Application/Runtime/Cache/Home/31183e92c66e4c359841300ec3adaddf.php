  ...
  <table class="layui-table">
    ...
    <tbody>
      <?php if(is_array($masData)): foreach($masData as $key=>$vo): ?><tr>
        ...
        <td> <a href="<?php echo U('Home/teacher/xsStudent',array('id'=>$vo['id']));?>">查看</a> | <a href="<?php echo U('Home/teacher/editStudent',array('id'=>$vo['id']));?>">修改</a> | <a href="<?php echo U('Home/teacher/delStudent',array('id'=>$vo['id']));?>">删除</a></td>
