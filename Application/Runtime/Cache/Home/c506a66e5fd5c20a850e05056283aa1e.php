...
<head>
    ...
    <link rel="stylesheet" href="/rewards/Public/build/css/app.css" media="all">
</head>

<body>
    <div class="layui-layout layui-layout-admin kit-layout-admin">
        <div class="layui-header">
            <div class="layui-logo">超级管理员</div>
            ...
            <ul class="layui-nav layui-layout-left kit-nav">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;">量化管理系统</a></dd>
                        <dd><a href="javascript:;">学生请假系统</a></dd>
                    </dl>
                </li>
            </ul>
            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="kitNavbar" kit-navbar>
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd>
                                <a href="javascript:;" kit-target data-options="{url:'student.html',icon:'&#xe6c6;',title:'表格',id:'1'}">
                                    <i class="layui-icon">&#xe6c6;</i><span> 学生资料</span></a>
                            </dd>
                            <dd>
        ...
        layui.config({
            ...
            $('#pay').on('click', function() {
                layer.open({
                    title: false,
                    type: 1,
                    content: '<img src="/rewards/Public/build/images/pay.png" />',
                    area: ['500px', '250px'],
                    shadeClose: true
                });
            });
